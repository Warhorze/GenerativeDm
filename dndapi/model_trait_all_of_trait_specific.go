...
// TraitAllOfTraitSpecific - Information specific to this trait
type TraitAllOfTraitSpecific struct {
	Choice *Choice
	TraitAllOfTraitSpecificOneOf *TraitAllOfTraitSpecificOneOf
}

// ChoiceAsTraitAllOfTraitSpecific is a convenience function that returns Choice wrapped in TraitAllOfTraitSpecific
func ChoiceAsTraitAllOfTraitSpecific(v *Choice) TraitAllOfTraitSpecific {
	return TraitAllOfTraitSpecific{
		Choice: v,
	}
}

// TraitAllOfTraitSpecificOneOfAsTraitAllOfTraitSpecific is a convenience function that returns TraitAllOfTraitSpecificOneOf wrapped in TraitAllOfTraitSpecific
func TraitAllOfTraitSpecificOneOfAsTraitAllOfTraitSpecific(v *TraitAllOfTraitSpecificOneOf) TraitAllOfTraitSpecific {
	return TraitAllOfTraitSpecific{
		TraitAllOfTraitSpecificOneOf: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *TraitAllOfTraitSpecific) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into Choice
	err = newStrictDecoder(data).Decode(&dst.Choice)
	if err == nil {
		jsonChoice, _ := json.Marshal(dst.Choice)
		if string(jsonChoice) == "{}" { // empty struct
			dst.Choice = nil
		} else {
			match++
		}
	...
	// try to unmarshal data into TraitAllOfTraitSpecificOneOf
	err = newStrictDecoder(data).Decode(&dst.TraitAllOfTraitSpecificOneOf)
	if err == nil {
		jsonTraitAllOfTraitSpecificOneOf, _ := json.Marshal(dst.TraitAllOfTraitSpecificOneOf)
		if string(jsonTraitAllOfTraitSpecificOneOf) == "{}" { // empty struct
			dst.TraitAllOfTraitSpecificOneOf = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TraitAllOfTraitSpecific)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TraitAllOfTraitSpecific)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src TraitAllOfTraitSpecific) MarshalJSON() ([]byte, error) {
	if src.Choice != nil {
		return json.Marshal(&src.Choice)
	}

	if src.TraitAllOfTraitSpecificOneOf != nil {
		return json.Marshal(&src.TraitAllOfTraitSpecificOneOf)
	}
...
func (obj *TraitAllOfTraitSpecific) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.Choice != nil {
	...
	if obj.TraitAllOfTraitSpecificOneOf != nil {
		return obj.TraitAllOfTraitSpecificOneOf
	}
...
type NullableTraitAllOfTraitSpecific struct {
	value *TraitAllOfTraitSpecific
	isSet bool
}

func (v NullableTraitAllOfTraitSpecific) Get() *TraitAllOfTraitSpecific {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecific) Set(val *TraitAllOfTraitSpecific) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecific) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecific) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecific(val *TraitAllOfTraitSpecific) *NullableTraitAllOfTraitSpecific {
	return &NullableTraitAllOfTraitSpecific{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecific) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecific) UnmarshalJSON(src []byte) error {
	v.isSet = true
