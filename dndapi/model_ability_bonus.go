...
// checks if the AbilityBonus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityBonus{}
...
func (o AbilityBonus) ToMap() (map[string]interface{}, error) {
