...
// checks if the OptionOneOf8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf8{}
...
func (o OptionOneOf8) ToMap() (map[string]interface{}, error) {
