...
// checks if the OptionOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf2{}
...
func (o OptionOneOf2) ToMap() (map[string]interface{}, error) {
