...
// checks if the FeatureAllOfPrerequisitesInnerAnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureAllOfPrerequisitesInnerAnyOf{}

// FeatureAllOfPrerequisitesInnerAnyOf struct for FeatureAllOfPrerequisitesInnerAnyOf
type FeatureAllOfPrerequisitesInnerAnyOf struct {
...
func NewFeatureAllOfPrerequisitesInnerAnyOf() *FeatureAllOfPrerequisitesInnerAnyOf {
	this := FeatureAllOfPrerequisitesInnerAnyOf{}
	return &this
}
...
func (o FeatureAllOfPrerequisitesInnerAnyOf) MarshalJSON() ([]byte, error) {
...
func (o FeatureAllOfPrerequisitesInnerAnyOf) ToMap() (map[string]interface{}, error) {
...
type NullableFeatureAllOfPrerequisitesInnerAnyOf struct {
	value *FeatureAllOfPrerequisitesInnerAnyOf
	isSet bool
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf) Get() *FeatureAllOfPrerequisitesInnerAnyOf {
	return v.value
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf) Set(val *FeatureAllOfPrerequisitesInnerAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureAllOfPrerequisitesInnerAnyOf(val *FeatureAllOfPrerequisitesInnerAnyOf) *NullableFeatureAllOfPrerequisitesInnerAnyOf {
	return &NullableFeatureAllOfPrerequisitesInnerAnyOf{value: val, isSet: true}
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
