...
// checks if the DamageAtSlotLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DamageAtSlotLevel{}
...
func (o DamageAtSlotLevel) ToMap() (map[string]interface{}, error) {
