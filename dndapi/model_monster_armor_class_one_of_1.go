...
// checks if the MonsterArmorClassOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterArmorClassOneOf1{}

// MonsterArmorClassOneOf1 struct for MonsterArmorClassOneOf1
type MonsterArmorClassOneOf1 struct {
...
func (o MonsterArmorClassOneOf1) MarshalJSON() ([]byte, error) {
...
func (o MonsterArmorClassOneOf1) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterArmorClassOneOf1 struct {
	value *MonsterArmorClassOneOf1
	isSet bool
}

func (v NullableMonsterArmorClassOneOf1) Get() *MonsterArmorClassOneOf1 {
	return v.value
}

func (v *NullableMonsterArmorClassOneOf1) Set(val *MonsterArmorClassOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterArmorClassOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterArmorClassOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterArmorClassOneOf1(val *MonsterArmorClassOneOf1) *NullableMonsterArmorClassOneOf1 {
	return &NullableMonsterArmorClassOneOf1{value: val, isSet: true}
}

func (v NullableMonsterArmorClassOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterArmorClassOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
