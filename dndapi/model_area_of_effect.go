...
// checks if the AreaOfEffect type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AreaOfEffect{}
...
func (o AreaOfEffect) ToMap() (map[string]interface{}, error) {
