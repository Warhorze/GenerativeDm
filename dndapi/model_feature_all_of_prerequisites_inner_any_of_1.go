...
// checks if the FeatureAllOfPrerequisitesInnerAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureAllOfPrerequisitesInnerAnyOf1{}

// FeatureAllOfPrerequisitesInnerAnyOf1 struct for FeatureAllOfPrerequisitesInnerAnyOf1
type FeatureAllOfPrerequisitesInnerAnyOf1 struct {
...
func NewFeatureAllOfPrerequisitesInnerAnyOf1() *FeatureAllOfPrerequisitesInnerAnyOf1 {
	this := FeatureAllOfPrerequisitesInnerAnyOf1{}
	return &this
}
...
func (o FeatureAllOfPrerequisitesInnerAnyOf1) MarshalJSON() ([]byte, error) {
...
func (o FeatureAllOfPrerequisitesInnerAnyOf1) ToMap() (map[string]interface{}, error) {
...
type NullableFeatureAllOfPrerequisitesInnerAnyOf1 struct {
	value *FeatureAllOfPrerequisitesInnerAnyOf1
	isSet bool
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf1) Get() *FeatureAllOfPrerequisitesInnerAnyOf1 {
	return v.value
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf1) Set(val *FeatureAllOfPrerequisitesInnerAnyOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureAllOfPrerequisitesInnerAnyOf1(val *FeatureAllOfPrerequisitesInnerAnyOf1) *NullableFeatureAllOfPrerequisitesInnerAnyOf1 {
	return &NullableFeatureAllOfPrerequisitesInnerAnyOf1{value: val, isSet: true}
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
