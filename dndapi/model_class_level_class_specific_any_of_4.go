...
// checks if the ClassLevelClassSpecificAnyOf4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf4{}
...
func (o ClassLevelClassSpecificAnyOf4) ToMap() (map[string]interface{}, error) {
