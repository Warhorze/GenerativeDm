...
// checks if the MonsterSense type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterSense{}

// MonsterSense struct for MonsterSense
...
func (o MonsterSense) MarshalJSON() ([]byte, error) {
...
func (o MonsterSense) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterSense struct {
	value *MonsterSense
	isSet bool
}

func (v NullableMonsterSense) Get() *MonsterSense {
	return v.value
}

func (v *NullableMonsterSense) Set(val *MonsterSense) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterSense) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterSense) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterSense(val *MonsterSense) *NullableMonsterSense {
	return &NullableMonsterSense{value: val, isSet: true}
}

func (v NullableMonsterSense) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterSense) UnmarshalJSON(src []byte) error {
	v.isSet = true
