...
// checks if the OptionOneOf9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf9{}
...
func (o OptionOneOf9) ToMap() (map[string]interface{}, error) {
