...
// checks if the MonsterAllOfSenses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterAllOfSenses{}

// MonsterAllOfSenses Monsters typically have a passive perception but they might also have other senses to detect players.
type MonsterAllOfSenses struct {
...
// GetPassivePerception returns the PassivePerception field value if set, zero value otherwise.
func (o *MonsterAllOfSenses) GetPassivePerception() float32 {
	if o == nil || IsNil(o.PassivePerception) {
		var ret float32
		return ret
	}
	return *o.PassivePerception
}

// GetPassivePerceptionOk returns a tuple with the PassivePerception field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOfSenses) GetPassivePerceptionOk() (*float32, bool) {
	if o == nil || IsNil(o.PassivePerception) {
		return nil, false
	}
	return o.PassivePerception, true
}
...
// SetPassivePerception gets a reference to the given float32 and assigns it to the PassivePerception field.
func (o *MonsterAllOfSenses) SetPassivePerception(v float32) {
	o.PassivePerception = &v
}

// GetBlindsight returns the Blindsight field value if set, zero value otherwise.
func (o *MonsterAllOfSenses) GetBlindsight() string {
	if o == nil || IsNil(o.Blindsight) {
		var ret string
		return ret
	}
	return *o.Blindsight
...
// GetBlindsightOk returns a tuple with the Blindsight field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOfSenses) GetBlindsightOk() (*string, bool) {
	if o == nil || IsNil(o.Blindsight) {
		return nil, false
	}
	return o.Blindsight, true
}
...
// SetBlindsight gets a reference to the given string and assigns it to the Blindsight field.
func (o *MonsterAllOfSenses) SetBlindsight(v string) {
	o.Blindsight = &v
}

// GetDarkvision returns the Darkvision field value if set, zero value otherwise.
func (o *MonsterAllOfSenses) GetDarkvision() string {
	if o == nil || IsNil(o.Darkvision) {
		var ret string
		return ret
	}
	return *o.Darkvision
...
// GetDarkvisionOk returns a tuple with the Darkvision field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOfSenses) GetDarkvisionOk() (*string, bool) {
	if o == nil || IsNil(o.Darkvision) {
		return nil, false
	}
	return o.Darkvision, true
}
...
// SetDarkvision gets a reference to the given string and assigns it to the Darkvision field.
func (o *MonsterAllOfSenses) SetDarkvision(v string) {
	o.Darkvision = &v
}

// GetTremorsense returns the Tremorsense field value if set, zero value otherwise.
func (o *MonsterAllOfSenses) GetTremorsense() string {
	if o == nil || IsNil(o.Tremorsense) {
		var ret string
		return ret
	}
	return *o.Tremorsense
}

// GetTremorsenseOk returns a tuple with the Tremorsense field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOfSenses) GetTremorsenseOk() (*string, bool) {
	if o == nil || IsNil(o.Tremorsense) {
		return nil, false
	}
	return o.Tremorsense, true
}
...
// SetTremorsense gets a reference to the given string and assigns it to the Tremorsense field.
func (o *MonsterAllOfSenses) SetTremorsense(v string) {
	o.Tremorsense = &v
}

// GetTruesight returns the Truesight field value if set, zero value otherwise.
func (o *MonsterAllOfSenses) GetTruesight() string {
	if o == nil || IsNil(o.Truesight) {
		var ret string
		return ret
	}
	return *o.Truesight
...
// GetTruesightOk returns a tuple with the Truesight field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MonsterAllOfSenses) GetTruesightOk() (*string, bool) {
	if o == nil || IsNil(o.Truesight) {
		return nil, false
	}
	return o.Truesight, true
}
...
// SetTruesight gets a reference to the given string and assigns it to the Truesight field.
func (o *MonsterAllOfSenses) SetTruesight(v string) {
	o.Truesight = &v
}

func (o MonsterAllOfSenses) MarshalJSON() ([]byte, error) {
...
func (o MonsterAllOfSenses) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PassivePerception) {
		toSerialize["passive_perception"] = o.PassivePerception
	}
	if !IsNil(o.Blindsight) {
		toSerialize["blindsight"] = o.Blindsight
	}
	if !IsNil(o.Darkvision) {
		toSerialize["darkvision"] = o.Darkvision
	}
	if !IsNil(o.Tremorsense) {
		toSerialize["tremorsense"] = o.Tremorsense
	}
	if !IsNil(o.Truesight) {
		toSerialize["truesight"] = o.Truesight
	}
	return toSerialize, nil
}

type NullableMonsterAllOfSenses struct {
	value *MonsterAllOfSenses
	isSet bool
}

func (v NullableMonsterAllOfSenses) Get() *MonsterAllOfSenses {
	return v.value
}

func (v *NullableMonsterAllOfSenses) Set(val *MonsterAllOfSenses) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAllOfSenses) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAllOfSenses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAllOfSenses(val *MonsterAllOfSenses) *NullableMonsterAllOfSenses {
	return &NullableMonsterAllOfSenses{value: val, isSet: true}
}

func (v NullableMonsterAllOfSenses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAllOfSenses) UnmarshalJSON(src []byte) error {
	v.isSet = true
