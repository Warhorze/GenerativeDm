...
// checks if the MagicSchool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagicSchool{}
...
func (o MagicSchool) ToMap() (map[string]interface{}, error) {
