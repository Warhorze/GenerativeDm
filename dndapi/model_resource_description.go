...
// checks if the ResourceDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDescription{}
...
func (o ResourceDescription) ToMap() (map[string]interface{}, error) {
