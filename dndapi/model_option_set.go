...
type OptionSet struct {
	OptionSetOneOf *OptionSetOneOf
	OptionSetOneOf1 *OptionSetOneOf1
	OptionSetOneOf2 *OptionSetOneOf2
}

// OptionSetOneOfAsOptionSet is a convenience function that returns OptionSetOneOf wrapped in OptionSet
func OptionSetOneOfAsOptionSet(v *OptionSetOneOf) OptionSet {
	return OptionSet{
		OptionSetOneOf: v,
	}
}

// OptionSetOneOf1AsOptionSet is a convenience function that returns OptionSetOneOf1 wrapped in OptionSet
func OptionSetOneOf1AsOptionSet(v *OptionSetOneOf1) OptionSet {
	return OptionSet{
		OptionSetOneOf1: v,
	}
}

// OptionSetOneOf2AsOptionSet is a convenience function that returns OptionSetOneOf2 wrapped in OptionSet
func OptionSetOneOf2AsOptionSet(v *OptionSetOneOf2) OptionSet {
	return OptionSet{
		OptionSetOneOf2: v,
	}
}
...
func (dst *OptionSet) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into OptionSetOneOf
	err = newStrictDecoder(data).Decode(&dst.OptionSetOneOf)
	if err == nil {
		jsonOptionSetOneOf, _ := json.Marshal(dst.OptionSetOneOf)
		if string(jsonOptionSetOneOf) == "{}" { // empty struct
			dst.OptionSetOneOf = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into OptionSetOneOf1
	err = newStrictDecoder(data).Decode(&dst.OptionSetOneOf1)
	if err == nil {
		jsonOptionSetOneOf1, _ := json.Marshal(dst.OptionSetOneOf1)
		if string(jsonOptionSetOneOf1) == "{}" { // empty struct
			dst.OptionSetOneOf1 = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into OptionSetOneOf2
	err = newStrictDecoder(data).Decode(&dst.OptionSetOneOf2)
	if err == nil {
		jsonOptionSetOneOf2, _ := json.Marshal(dst.OptionSetOneOf2)
		if string(jsonOptionSetOneOf2) == "{}" { // empty struct
			dst.OptionSetOneOf2 = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(OptionSet)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(OptionSet)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src OptionSet) MarshalJSON() ([]byte, error) {
	if src.OptionSetOneOf != nil {
		return json.Marshal(&src.OptionSetOneOf)
	}

	if src.OptionSetOneOf1 != nil {
		return json.Marshal(&src.OptionSetOneOf1)
	}

	if src.OptionSetOneOf2 != nil {
		return json.Marshal(&src.OptionSetOneOf2)
	}
...
func (obj *OptionSet) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.OptionSetOneOf != nil {
		return obj.OptionSetOneOf
	}

	if obj.OptionSetOneOf1 != nil {
		return obj.OptionSetOneOf1
	}

	if obj.OptionSetOneOf2 != nil {
		return obj.OptionSetOneOf2
	}
