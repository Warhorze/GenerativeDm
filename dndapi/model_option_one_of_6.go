...
// checks if the OptionOneOf6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf6{}
...
func (o OptionOneOf6) ToMap() (map[string]interface{}, error) {
