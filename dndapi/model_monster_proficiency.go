...
// checks if the MonsterProficiency type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterProficiency{}

// MonsterProficiency struct for MonsterProficiency
...
func (o MonsterProficiency) MarshalJSON() ([]byte, error) {
...
func (o MonsterProficiency) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterProficiency struct {
	value *MonsterProficiency
	isSet bool
}

func (v NullableMonsterProficiency) Get() *MonsterProficiency {
	return v.value
}

func (v *NullableMonsterProficiency) Set(val *MonsterProficiency) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterProficiency) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterProficiency) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterProficiency(val *MonsterProficiency) *NullableMonsterProficiency {
	return &NullableMonsterProficiency{value: val, isSet: true}
}

func (v NullableMonsterProficiency) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterProficiency) UnmarshalJSON(src []byte) error {
	v.isSet = true
