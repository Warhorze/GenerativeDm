...
// checks if the MonsterArmorClassOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterArmorClassOneOf{}

// MonsterArmorClassOneOf struct for MonsterArmorClassOneOf
type MonsterArmorClassOneOf struct {
...
func (o MonsterArmorClassOneOf) MarshalJSON() ([]byte, error) {
...
func (o MonsterArmorClassOneOf) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterArmorClassOneOf struct {
	value *MonsterArmorClassOneOf
	isSet bool
}

func (v NullableMonsterArmorClassOneOf) Get() *MonsterArmorClassOneOf {
	return v.value
}

func (v *NullableMonsterArmorClassOneOf) Set(val *MonsterArmorClassOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterArmorClassOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterArmorClassOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterArmorClassOneOf(val *MonsterArmorClassOneOf) *NullableMonsterArmorClassOneOf {
	return &NullableMonsterArmorClassOneOf{value: val, isSet: true}
}

func (v NullableMonsterArmorClassOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterArmorClassOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
