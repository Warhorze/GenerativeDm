...
// checks if the MonsterSpellcasting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterSpellcasting{}

// MonsterSpellcasting struct for MonsterSpellcasting
...
// SetSpells gets a reference to the given []MonsterSpell and assigns it to the Spells field.
func (o *MonsterSpellcasting) SetSpells(v []MonsterSpell) {
	o.Spells = v
}

func (o MonsterSpellcasting) MarshalJSON() ([]byte, error) {
...
func (o MonsterSpellcasting) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterSpellcasting struct {
	value *MonsterSpellcasting
	isSet bool
}

func (v NullableMonsterSpellcasting) Get() *MonsterSpellcasting {
	return v.value
}

func (v *NullableMonsterSpellcasting) Set(val *MonsterSpellcasting) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterSpellcasting) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterSpellcasting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterSpellcasting(val *MonsterSpellcasting) *NullableMonsterSpellcasting {
	return &NullableMonsterSpellcasting{value: val, isSet: true}
}

func (v NullableMonsterSpellcasting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterSpellcasting) UnmarshalJSON(src []byte) error {
	v.isSet = true
