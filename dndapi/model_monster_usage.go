...
// checks if the MonsterUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterUsage{}

// MonsterUsage struct for MonsterUsage
...
func (o MonsterUsage) MarshalJSON() ([]byte, error) {
...
func (o MonsterUsage) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterUsage struct {
	value *MonsterUsage
	isSet bool
}

func (v NullableMonsterUsage) Get() *MonsterUsage {
	return v.value
}

func (v *NullableMonsterUsage) Set(val *MonsterUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterUsage(val *MonsterUsage) *NullableMonsterUsage {
	return &NullableMonsterUsage{value: val, isSet: true}
}

func (v NullableMonsterUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
