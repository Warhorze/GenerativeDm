...
// checks if the FeatureAllOfPrerequisitesInnerAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureAllOfPrerequisitesInnerAnyOf2{}

// FeatureAllOfPrerequisitesInnerAnyOf2 struct for FeatureAllOfPrerequisitesInnerAnyOf2
type FeatureAllOfPrerequisitesInnerAnyOf2 struct {
...
func NewFeatureAllOfPrerequisitesInnerAnyOf2() *FeatureAllOfPrerequisitesInnerAnyOf2 {
	this := FeatureAllOfPrerequisitesInnerAnyOf2{}
	return &this
}
...
// SetSpell gets a reference to the given string and assigns it to the Spell field.
func (o *FeatureAllOfPrerequisitesInnerAnyOf2) SetSpell(v string) {
	o.Spell = &v
}

func (o FeatureAllOfPrerequisitesInnerAnyOf2) MarshalJSON() ([]byte, error) {
...
func (o FeatureAllOfPrerequisitesInnerAnyOf2) ToMap() (map[string]interface{}, error) {
...
type NullableFeatureAllOfPrerequisitesInnerAnyOf2 struct {
	value *FeatureAllOfPrerequisitesInnerAnyOf2
	isSet bool
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf2) Get() *FeatureAllOfPrerequisitesInnerAnyOf2 {
	return v.value
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf2) Set(val *FeatureAllOfPrerequisitesInnerAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureAllOfPrerequisitesInnerAnyOf2(val *FeatureAllOfPrerequisitesInnerAnyOf2) *NullableFeatureAllOfPrerequisitesInnerAnyOf2 {
	return &NullableFeatureAllOfPrerequisitesInnerAnyOf2{value: val, isSet: true}
}

func (v NullableFeatureAllOfPrerequisitesInnerAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureAllOfPrerequisitesInnerAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
