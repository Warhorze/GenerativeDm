...
// checks if the Damage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Damage{}
...
func (o Damage) ToMap() (map[string]interface{}, error) {
