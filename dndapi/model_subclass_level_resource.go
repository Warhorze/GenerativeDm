...
// checks if the SubclassLevelResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubclassLevelResource{}
...
func (o SubclassLevelResource) ToMap() (map[string]interface{}, error) {
