...
// checks if the WeaponProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeaponProperty{}
...
func (o WeaponProperty) ToMap() (map[string]interface{}, error) {
