...
// checks if the SpellcastingInfoInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpellcastingInfoInner{}
...
func (o SpellcastingInfoInner) ToMap() (map[string]interface{}, error) {
