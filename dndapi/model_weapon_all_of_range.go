...
// checks if the WeaponAllOfRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeaponAllOfRange{}
...
func (o WeaponAllOfRange) ToMap() (map[string]interface{}, error) {
