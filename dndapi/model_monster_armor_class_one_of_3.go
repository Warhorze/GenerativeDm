...
// checks if the MonsterArmorClassOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterArmorClassOneOf3{}

// MonsterArmorClassOneOf3 struct for MonsterArmorClassOneOf3
type MonsterArmorClassOneOf3 struct {
...
func (o MonsterArmorClassOneOf3) MarshalJSON() ([]byte, error) {
...
func (o MonsterArmorClassOneOf3) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterArmorClassOneOf3 struct {
	value *MonsterArmorClassOneOf3
	isSet bool
}

func (v NullableMonsterArmorClassOneOf3) Get() *MonsterArmorClassOneOf3 {
	return v.value
}

func (v *NullableMonsterArmorClassOneOf3) Set(val *MonsterArmorClassOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterArmorClassOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterArmorClassOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterArmorClassOneOf3(val *MonsterArmorClassOneOf3) *NullableMonsterArmorClassOneOf3 {
	return &NullableMonsterArmorClassOneOf3{value: val, isSet: true}
}

func (v NullableMonsterArmorClassOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterArmorClassOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
