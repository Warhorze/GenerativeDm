...
// checks if the ClassLevelClassSpecificAnyOf11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf11{}
...
func (o ClassLevelClassSpecificAnyOf11) ToMap() (map[string]interface{}, error) {
