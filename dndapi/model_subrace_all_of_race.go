...
// checks if the SubraceAllOfRace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubraceAllOfRace{}

// SubraceAllOfRace Parent race for the subrace.
type SubraceAllOfRace struct {
...
func (o SubraceAllOfRace) MarshalJSON() ([]byte, error) {
...
func (o SubraceAllOfRace) ToMap() (map[string]interface{}, error) {
...
type NullableSubraceAllOfRace struct {
	value *SubraceAllOfRace
	isSet bool
}

func (v NullableSubraceAllOfRace) Get() *SubraceAllOfRace {
	return v.value
}

func (v *NullableSubraceAllOfRace) Set(val *SubraceAllOfRace) {
	v.value = val
	v.isSet = true
}

func (v NullableSubraceAllOfRace) IsSet() bool {
	return v.isSet
}

func (v *NullableSubraceAllOfRace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubraceAllOfRace(val *SubraceAllOfRace) *NullableSubraceAllOfRace {
	return &NullableSubraceAllOfRace{value: val, isSet: true}
}

func (v NullableSubraceAllOfRace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubraceAllOfRace) UnmarshalJSON(src []byte) error {
	v.isSet = true
