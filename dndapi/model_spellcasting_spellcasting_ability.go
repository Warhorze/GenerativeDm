...
// checks if the SpellcastingSpellcastingAbility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpellcastingSpellcastingAbility{}
...
func (o SpellcastingSpellcastingAbility) ToMap() (map[string]interface{}, error) {
