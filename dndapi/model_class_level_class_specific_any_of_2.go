...
// checks if the ClassLevelClassSpecificAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf2{}
...
func (o ClassLevelClassSpecificAnyOf2) ToMap() (map[string]interface{}, error) {
