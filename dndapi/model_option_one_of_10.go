...
// checks if the OptionOneOf10 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf10{}
...
func (o OptionOneOf10) ToMap() (map[string]interface{}, error) {
