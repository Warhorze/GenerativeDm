...
// checks if the APIReferenceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &APIReferenceList{}
...
func (o APIReferenceList) ToMap() (map[string]interface{}, error) {
