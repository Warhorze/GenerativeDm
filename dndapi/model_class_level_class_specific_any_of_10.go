...
// checks if the ClassLevelClassSpecificAnyOf10 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf10{}
...
func (o ClassLevelClassSpecificAnyOf10) ToMap() (map[string]interface{}, error) {
