...
// checks if the TraitAllOfTraitSpecificOneOfBreathWeaponDamage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraitAllOfTraitSpecificOneOfBreathWeaponDamage{}

// TraitAllOfTraitSpecificOneOfBreathWeaponDamage struct for TraitAllOfTraitSpecificOneOfBreathWeaponDamage
type TraitAllOfTraitSpecificOneOfBreathWeaponDamage struct {
	DamageAtCharacterLevel *map[string]string `json:"damage_at_character_level,omitempty"`
	DamageType *PrerequisiteAbilityScore `json:"damage_type,omitempty"`
}
...
func NewTraitAllOfTraitSpecificOneOfBreathWeaponDamage() *TraitAllOfTraitSpecificOneOfBreathWeaponDamage {
	this := TraitAllOfTraitSpecificOneOfBreathWeaponDamage{}
	return &this
}
...
// SetDamageAtCharacterLevel gets a reference to the given map[string]string and assigns it to the DamageAtCharacterLevel field.
...
// SetDamageType gets a reference to the given PrerequisiteAbilityScore and assigns it to the DamageType field.
func (o *TraitAllOfTraitSpecificOneOfBreathWeaponDamage) SetDamageType(v PrerequisiteAbilityScore) {
	o.DamageType = &v
}

func (o TraitAllOfTraitSpecificOneOfBreathWeaponDamage) MarshalJSON() ([]byte, error) {
...
func (o TraitAllOfTraitSpecificOneOfBreathWeaponDamage) ToMap() (map[string]interface{}, error) {
...
type NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage struct {
	value *TraitAllOfTraitSpecificOneOfBreathWeaponDamage
	isSet bool
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) Get() *TraitAllOfTraitSpecificOneOfBreathWeaponDamage {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) Set(val *TraitAllOfTraitSpecificOneOfBreathWeaponDamage) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage(val *TraitAllOfTraitSpecificOneOfBreathWeaponDamage) *NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage {
	return &NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponDamage) UnmarshalJSON(src []byte) error {
	v.isSet = true
