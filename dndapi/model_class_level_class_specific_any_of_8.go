...
// checks if the ClassLevelClassSpecificAnyOf8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf8{}
...
func (o ClassLevelClassSpecificAnyOf8) ToMap() (map[string]interface{}, error) {
