...
// checks if the ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner{}
...
func (o ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner) ToMap() (map[string]interface{}, error) {
