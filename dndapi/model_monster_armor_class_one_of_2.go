...
// checks if the MonsterArmorClassOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterArmorClassOneOf2{}

// MonsterArmorClassOneOf2 struct for MonsterArmorClassOneOf2
type MonsterArmorClassOneOf2 struct {
...
// SetArmor gets a reference to the given []APIReference and assigns it to the Armor field.
...
func (o MonsterArmorClassOneOf2) MarshalJSON() ([]byte, error) {
...
func (o MonsterArmorClassOneOf2) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterArmorClassOneOf2 struct {
	value *MonsterArmorClassOneOf2
	isSet bool
}

func (v NullableMonsterArmorClassOneOf2) Get() *MonsterArmorClassOneOf2 {
	return v.value
}

func (v *NullableMonsterArmorClassOneOf2) Set(val *MonsterArmorClassOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterArmorClassOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterArmorClassOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterArmorClassOneOf2(val *MonsterArmorClassOneOf2) *NullableMonsterArmorClassOneOf2 {
	return &NullableMonsterArmorClassOneOf2{value: val, isSet: true}
}

func (v NullableMonsterArmorClassOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterArmorClassOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
