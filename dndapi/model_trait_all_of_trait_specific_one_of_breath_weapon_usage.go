...
// checks if the TraitAllOfTraitSpecificOneOfBreathWeaponUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraitAllOfTraitSpecificOneOfBreathWeaponUsage{}

// TraitAllOfTraitSpecificOneOfBreathWeaponUsage Description of the usage constraints of this action.
type TraitAllOfTraitSpecificOneOfBreathWeaponUsage struct {
...
func NewTraitAllOfTraitSpecificOneOfBreathWeaponUsage() *TraitAllOfTraitSpecificOneOfBreathWeaponUsage {
	this := TraitAllOfTraitSpecificOneOfBreathWeaponUsage{}
	return &this
}
...
func (o TraitAllOfTraitSpecificOneOfBreathWeaponUsage) MarshalJSON() ([]byte, error) {
...
func (o TraitAllOfTraitSpecificOneOfBreathWeaponUsage) ToMap() (map[string]interface{}, error) {
...
type NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage struct {
	value *TraitAllOfTraitSpecificOneOfBreathWeaponUsage
	isSet bool
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) Get() *TraitAllOfTraitSpecificOneOfBreathWeaponUsage {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) Set(val *TraitAllOfTraitSpecificOneOfBreathWeaponUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage(val *TraitAllOfTraitSpecificOneOfBreathWeaponUsage) *NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage {
	return &NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeaponUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
