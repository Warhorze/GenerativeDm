...
// checks if the ClassLevelClassSpecificAnyOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf3{}
...
func (o ClassLevelClassSpecificAnyOf3) ToMap() (map[string]interface{}, error) {
