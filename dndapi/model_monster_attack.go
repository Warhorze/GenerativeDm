...
// checks if the MonsterAttack type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterAttack{}

// MonsterAttack struct for MonsterAttack
...
func (o MonsterAttack) MarshalJSON() ([]byte, error) {
...
func (o MonsterAttack) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterAttack struct {
	value *MonsterAttack
	isSet bool
}

func (v NullableMonsterAttack) Get() *MonsterAttack {
	return v.value
}

func (v *NullableMonsterAttack) Set(val *MonsterAttack) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAttack) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAttack) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAttack(val *MonsterAttack) *NullableMonsterAttack {
	return &NullableMonsterAttack{value: val, isSet: true}
}

func (v NullableMonsterAttack) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAttack) UnmarshalJSON(src []byte) error {
	v.isSet = true
