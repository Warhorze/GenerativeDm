...
// checks if the MonsterAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterAction{}
...
func (o *MonsterAction) GetActions() []MonsterMultiAttackAction {
	if o == nil || IsNil(o.Actions) {
		var ret []MonsterMultiAttackAction
		return ret
	}
	return o.Actions
}
...
// SetActions gets a reference to the given []MonsterMultiAttackAction and assigns it to the Actions field.
...
// SetAttacks gets a reference to the given []MonsterAttack and assigns it to the Attacks field.
...
func (o MonsterAction) MarshalJSON() ([]byte, error) {
...
func (o MonsterAction) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterAction struct {
	value *MonsterAction
	isSet bool
}

func (v NullableMonsterAction) Get() *MonsterAction {
	return v.value
}

func (v *NullableMonsterAction) Set(val *MonsterAction) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAction) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAction(val *MonsterAction) *NullableMonsterAction {
	return &NullableMonsterAction{value: val, isSet: true}
}

func (v NullableMonsterAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
