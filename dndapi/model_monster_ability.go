...
// checks if the MonsterAbility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterAbility{}
...
func (o MonsterAbility) MarshalJSON() ([]byte, error) {
...
func (o MonsterAbility) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterAbility struct {
	value *MonsterAbility
	isSet bool
}

func (v NullableMonsterAbility) Get() *MonsterAbility {
	return v.value
}

func (v *NullableMonsterAbility) Set(val *MonsterAbility) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterAbility) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterAbility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterAbility(val *MonsterAbility) *NullableMonsterAbility {
	return &NullableMonsterAbility{value: val, isSet: true}
}

func (v NullableMonsterAbility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterAbility) UnmarshalJSON(src []byte) error {
	v.isSet = true
