...
// checks if the Proficiency type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Proficiency{}
...
type Proficiency struct {
	...
	Reference *ProficiencyAllOfReference `json:"reference,omitempty"`
}
...
func (o *Proficiency) GetReference() ProficiencyAllOfReference {
	if o == nil || IsNil(o.Reference) {
		var ret ProficiencyAllOfReference
		return ret
	}
	return *o.Reference
}
...
// SetReference gets a reference to the given ProficiencyAllOfReference and assigns it to the Reference field.
...
func (o Proficiency) ToMap() (map[string]interface{}, error) {
