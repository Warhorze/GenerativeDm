...
// checks if the OptionOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf{}
...
func (o OptionOneOf) ToMap() (map[string]interface{}, error) {
