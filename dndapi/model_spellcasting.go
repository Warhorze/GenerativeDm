...
// checks if the Spellcasting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Spellcasting{}
...
func (o Spellcasting) ToMap() (map[string]interface{}, error) {
