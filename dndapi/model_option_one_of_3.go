...
// checks if the OptionOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf3{}
...
func (o OptionOneOf3) ToMap() (map[string]interface{}, error) {
