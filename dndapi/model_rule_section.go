...
// checks if the RuleSection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleSection{}
...
func (o RuleSection) ToMap() (map[string]interface{}, error) {
