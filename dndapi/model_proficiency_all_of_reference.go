...
// checks if the ProficiencyAllOfReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProficiencyAllOfReference{}

// ProficiencyAllOfReference `APIReference` to the full description of the related resource. 
type ProficiencyAllOfReference struct {
...
func NewProficiencyAllOfReference() *ProficiencyAllOfReference {
	this := ProficiencyAllOfReference{}
	return &this
}
...
func (o ProficiencyAllOfReference) MarshalJSON() ([]byte, error) {
...
func (o ProficiencyAllOfReference) ToMap() (map[string]interface{}, error) {
...
type NullableProficiencyAllOfReference struct {
	value *ProficiencyAllOfReference
	isSet bool
}

func (v NullableProficiencyAllOfReference) Get() *ProficiencyAllOfReference {
	return v.value
}

func (v *NullableProficiencyAllOfReference) Set(val *ProficiencyAllOfReference) {
	v.value = val
	v.isSet = true
}

func (v NullableProficiencyAllOfReference) IsSet() bool {
	return v.isSet
}

func (v *NullableProficiencyAllOfReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProficiencyAllOfReference(val *ProficiencyAllOfReference) *NullableProficiencyAllOfReference {
	return &NullableProficiencyAllOfReference{value: val, isSet: true}
}

func (v NullableProficiencyAllOfReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProficiencyAllOfReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
