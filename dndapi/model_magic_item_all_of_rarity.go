...
// checks if the MagicItemAllOfRarity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagicItemAllOfRarity{}
...
func (o MagicItemAllOfRarity) ToMap() (map[string]interface{}, error) {
