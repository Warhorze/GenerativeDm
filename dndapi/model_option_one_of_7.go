...
// checks if the OptionOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf7{}
...
func (o OptionOneOf7) ToMap() (map[string]interface{}, error) {
