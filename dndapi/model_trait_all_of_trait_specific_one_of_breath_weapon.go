...
// checks if the TraitAllOfTraitSpecificOneOfBreathWeapon type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraitAllOfTraitSpecificOneOfBreathWeapon{}

// TraitAllOfTraitSpecificOneOfBreathWeapon The breath weapon action associated with a draconic ancestry.
type TraitAllOfTraitSpecificOneOfBreathWeapon struct {
	Name *string `json:"name,omitempty"`
	Desc *string `json:"desc,omitempty"`
	AreaOfEffect *AreaOfEffect `json:"area_of_effect,omitempty"`
	Damage *TraitAllOfTraitSpecificOneOfBreathWeaponDamage `json:"damage,omitempty"`
	Dc *DC `json:"dc,omitempty"`
	Usage *TraitAllOfTraitSpecificOneOfBreathWeaponUsage `json:"usage,omitempty"`
}
...
func NewTraitAllOfTraitSpecificOneOfBreathWeapon() *TraitAllOfTraitSpecificOneOfBreathWeapon {
	this := TraitAllOfTraitSpecificOneOfBreathWeapon{}
	return &this
}
...
func (o *TraitAllOfTraitSpecificOneOfBreathWeapon) GetDamage() TraitAllOfTraitSpecificOneOfBreathWeaponDamage {
	if o == nil || IsNil(o.Damage) {
		var ret TraitAllOfTraitSpecificOneOfBreathWeaponDamage
		return ret
	}
	return *o.Damage
}
...
// SetDamage gets a reference to the given TraitAllOfTraitSpecificOneOfBreathWeaponDamage and assigns it to the Damage field.
...
func (o *TraitAllOfTraitSpecificOneOfBreathWeapon) GetUsage() TraitAllOfTraitSpecificOneOfBreathWeaponUsage {
	if o == nil || IsNil(o.Usage) {
		var ret TraitAllOfTraitSpecificOneOfBreathWeaponUsage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given TraitAllOfTraitSpecificOneOfBreathWeaponUsage and assigns it to the Usage field.
func (o *TraitAllOfTraitSpecificOneOfBreathWeapon) SetUsage(v TraitAllOfTraitSpecificOneOfBreathWeaponUsage) {
	o.Usage = &v
}

func (o TraitAllOfTraitSpecificOneOfBreathWeapon) MarshalJSON() ([]byte, error) {
...
func (o TraitAllOfTraitSpecificOneOfBreathWeapon) ToMap() (map[string]interface{}, error) {
...
type NullableTraitAllOfTraitSpecificOneOfBreathWeapon struct {
	value *TraitAllOfTraitSpecificOneOfBreathWeapon
	isSet bool
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeapon) Get() *TraitAllOfTraitSpecificOneOfBreathWeapon {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeapon) Set(val *TraitAllOfTraitSpecificOneOfBreathWeapon) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeapon) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeapon) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecificOneOfBreathWeapon(val *TraitAllOfTraitSpecificOneOfBreathWeapon) *NullableTraitAllOfTraitSpecificOneOfBreathWeapon {
	return &NullableTraitAllOfTraitSpecificOneOfBreathWeapon{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecificOneOfBreathWeapon) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecificOneOfBreathWeapon) UnmarshalJSON(src []byte) error {
	v.isSet = true
