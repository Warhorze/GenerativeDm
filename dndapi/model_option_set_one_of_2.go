...
// checks if the OptionSetOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionSetOneOf2{}
...
func (o OptionSetOneOf2) ToMap() (map[string]interface{}, error) {
