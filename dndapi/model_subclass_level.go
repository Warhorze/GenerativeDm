...
// checks if the SubclassLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubclassLevel{}
...
func (o SubclassLevel) ToMap() (map[string]interface{}, error) {
