...
// checks if the MagicItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MagicItem{}
...
func (o MagicItem) ToMap() (map[string]interface{}, error) {
