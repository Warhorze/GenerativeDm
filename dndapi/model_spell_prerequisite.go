...
// checks if the SpellPrerequisite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpellPrerequisite{}
...
func (o SpellPrerequisite) ToMap() (map[string]interface{}, error) {
