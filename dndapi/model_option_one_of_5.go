...
// checks if the OptionOneOf5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf5{}
...
func (o OptionOneOf5) ToMap() (map[string]interface{}, error) {
