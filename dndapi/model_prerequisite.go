...
// checks if the Prerequisite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Prerequisite{}
...
func (o Prerequisite) ToMap() (map[string]interface{}, error) {
