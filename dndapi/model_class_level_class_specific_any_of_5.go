...
// checks if the ClassLevelClassSpecificAnyOf5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf5{}
...
func (o ClassLevelClassSpecificAnyOf5) ToMap() (map[string]interface{}, error) {
