...
// checks if the MonsterArmorClassOneOf4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterArmorClassOneOf4{}

// MonsterArmorClassOneOf4 struct for MonsterArmorClassOneOf4
type MonsterArmorClassOneOf4 struct {
...
// SetCondition gets a reference to the given APIReference and assigns it to the Condition field.
...
func (o MonsterArmorClassOneOf4) MarshalJSON() ([]byte, error) {
...
func (o MonsterArmorClassOneOf4) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterArmorClassOneOf4 struct {
	value *MonsterArmorClassOneOf4
	isSet bool
}

func (v NullableMonsterArmorClassOneOf4) Get() *MonsterArmorClassOneOf4 {
	return v.value
}

func (v *NullableMonsterArmorClassOneOf4) Set(val *MonsterArmorClassOneOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterArmorClassOneOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterArmorClassOneOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterArmorClassOneOf4(val *MonsterArmorClassOneOf4) *NullableMonsterArmorClassOneOf4 {
	return &NullableMonsterArmorClassOneOf4{value: val, isSet: true}
}

func (v NullableMonsterArmorClassOneOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterArmorClassOneOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true
