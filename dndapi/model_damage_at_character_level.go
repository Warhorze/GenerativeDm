...
// checks if the DamageAtCharacterLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DamageAtCharacterLevel{}
...
func (o DamageAtCharacterLevel) ToMap() (map[string]interface{}, error) {
