...
// checks if the AbilityScore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityScore{}
...
func (o AbilityScore) ToMap() (map[string]interface{}, error) {
