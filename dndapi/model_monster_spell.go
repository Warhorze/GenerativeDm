...
// checks if the MonsterSpell type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterSpell{}

// MonsterSpell struct for MonsterSpell
...
func (o MonsterSpell) MarshalJSON() ([]byte, error) {
...
func (o MonsterSpell) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterSpell struct {
	value *MonsterSpell
	isSet bool
}

func (v NullableMonsterSpell) Get() *MonsterSpell {
	return v.value
}

func (v *NullableMonsterSpell) Set(val *MonsterSpell) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterSpell) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterSpell) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterSpell(val *MonsterSpell) *NullableMonsterSpell {
	return &NullableMonsterSpell{value: val, isSet: true}
}

func (v NullableMonsterSpell) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterSpell) UnmarshalJSON(src []byte) error {
	v.isSet = true
