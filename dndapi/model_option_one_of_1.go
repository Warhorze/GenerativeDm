...
// checks if the OptionOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf1{}
...
func (o OptionOneOf1) ToMap() (map[string]interface{}, error) {
