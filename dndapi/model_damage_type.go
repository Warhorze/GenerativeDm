...
// checks if the DamageType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DamageType{}
...
func (o DamageType) ToMap() (map[string]interface{}, error) {
