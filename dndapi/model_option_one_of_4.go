...
// checks if the OptionOneOf4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionOneOf4{}
...
func (o OptionOneOf4) ToMap() (map[string]interface{}, error) {
