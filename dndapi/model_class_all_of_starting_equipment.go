...
// checks if the ClassAllOfStartingEquipment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassAllOfStartingEquipment{}
...
func (o ClassAllOfStartingEquipment) ToMap() (map[string]interface{}, error) {
