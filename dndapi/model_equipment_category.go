...
// checks if the EquipmentCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EquipmentCategory{}
...
func (o EquipmentCategory) ToMap() (map[string]interface{}, error) {
