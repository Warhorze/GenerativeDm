...
// checks if the Armor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Armor{}
...
func (o Armor) ToMap() (map[string]interface{}, error) {
