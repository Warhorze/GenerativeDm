...
// checks if the MonsterMultiAttackAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonsterMultiAttackAction{}

// MonsterMultiAttackAction struct for MonsterMultiAttackAction
...
func (o MonsterMultiAttackAction) MarshalJSON() ([]byte, error) {
...
func (o MonsterMultiAttackAction) ToMap() (map[string]interface{}, error) {
...
type NullableMonsterMultiAttackAction struct {
	value *MonsterMultiAttackAction
	isSet bool
}

func (v NullableMonsterMultiAttackAction) Get() *MonsterMultiAttackAction {
	return v.value
}

func (v *NullableMonsterMultiAttackAction) Set(val *MonsterMultiAttackAction) {
	v.value = val
	v.isSet = true
}

func (v NullableMonsterMultiAttackAction) IsSet() bool {
	return v.isSet
}

func (v *NullableMonsterMultiAttackAction) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonsterMultiAttackAction(val *MonsterMultiAttackAction) *NullableMonsterMultiAttackAction {
	return &NullableMonsterMultiAttackAction{value: val, isSet: true}
}

func (v NullableMonsterMultiAttackAction) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonsterMultiAttackAction) UnmarshalJSON(src []byte) error {
	v.isSet = true
