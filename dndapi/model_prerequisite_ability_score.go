...
// checks if the PrerequisiteAbilityScore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrerequisiteAbilityScore{}
...
func (o PrerequisiteAbilityScore) ToMap() (map[string]interface{}, error) {
