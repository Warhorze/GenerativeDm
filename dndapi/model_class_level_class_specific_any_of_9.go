...
// checks if the ClassLevelClassSpecificAnyOf9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf9{}
...
func (o ClassLevelClassSpecificAnyOf9) ToMap() (map[string]interface{}, error) {
