...
// checks if the SubclassAllOfSpells type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubclassAllOfSpells{}
...
func (o SubclassAllOfSpells) ToMap() (map[string]interface{}, error) {
