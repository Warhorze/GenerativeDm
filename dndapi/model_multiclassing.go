...
// checks if the Multiclassing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Multiclassing{}
...
func (o Multiclassing) ToMap() (map[string]interface{}, error) {
