...
// checks if the ClassLevelClassSpecificAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf1{}
...
func (o ClassLevelClassSpecificAnyOf1) ToMap() (map[string]interface{}, error) {
