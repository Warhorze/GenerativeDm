...
// FeatureAllOfPrerequisitesInner struct for FeatureAllOfPrerequisitesInner
type FeatureAllOfPrerequisitesInner struct {
	FeatureAllOfPrerequisitesInnerAnyOf *FeatureAllOfPrerequisitesInnerAnyOf
	FeatureAllOfPrerequisitesInnerAnyOf1 *FeatureAllOfPrerequisitesInnerAnyOf1
	FeatureAllOfPrerequisitesInnerAnyOf2 *FeatureAllOfPrerequisitesInnerAnyOf2
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *FeatureAllOfPrerequisitesInner) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into FeatureAllOfPrerequisitesInnerAnyOf
	err = json.Unmarshal(data, &dst.FeatureAllOfPrerequisitesInnerAnyOf);
	if err == nil {
		jsonFeatureAllOfPrerequisitesInnerAnyOf, _ := json.Marshal(dst.FeatureAllOfPrerequisitesInnerAnyOf)
		if string(jsonFeatureAllOfPrerequisitesInnerAnyOf) == "{}" { // empty struct
			dst.FeatureAllOfPrerequisitesInnerAnyOf = nil
		} else {
			return nil // data stored in dst.FeatureAllOfPrerequisitesInnerAnyOf, return on the first match
		}
	} else {
		dst.FeatureAllOfPrerequisitesInnerAnyOf = nil
	}

	// try to unmarshal JSON data into FeatureAllOfPrerequisitesInnerAnyOf1
	err = json.Unmarshal(data, &dst.FeatureAllOfPrerequisitesInnerAnyOf1);
	if err == nil {
		jsonFeatureAllOfPrerequisitesInnerAnyOf1, _ := json.Marshal(dst.FeatureAllOfPrerequisitesInnerAnyOf1)
		if string(jsonFeatureAllOfPrerequisitesInnerAnyOf1) == "{}" { // empty struct
			dst.FeatureAllOfPrerequisitesInnerAnyOf1 = nil
		} else {
			return nil // data stored in dst.FeatureAllOfPrerequisitesInnerAnyOf1, return on the first match
		}
	} else {
		dst.FeatureAllOfPrerequisitesInnerAnyOf1 = nil
	}

	// try to unmarshal JSON data into FeatureAllOfPrerequisitesInnerAnyOf2
	err = json.Unmarshal(data, &dst.FeatureAllOfPrerequisitesInnerAnyOf2);
	if err == nil {
		jsonFeatureAllOfPrerequisitesInnerAnyOf2, _ := json.Marshal(dst.FeatureAllOfPrerequisitesInnerAnyOf2)
		if string(jsonFeatureAllOfPrerequisitesInnerAnyOf2) == "{}" { // empty struct
			dst.FeatureAllOfPrerequisitesInnerAnyOf2 = nil
		} else {
			return nil // data stored in dst.FeatureAllOfPrerequisitesInnerAnyOf2, return on the first match
		}
	} else {
		dst.FeatureAllOfPrerequisitesInnerAnyOf2 = nil
	}

	return fmt.Errorf("data failed to match schemas in anyOf(FeatureAllOfPrerequisitesInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *FeatureAllOfPrerequisitesInner) MarshalJSON() ([]byte, error) {
	if src.FeatureAllOfPrerequisitesInnerAnyOf != nil {
		return json.Marshal(&src.FeatureAllOfPrerequisitesInnerAnyOf)
	}

	if src.FeatureAllOfPrerequisitesInnerAnyOf1 != nil {
		return json.Marshal(&src.FeatureAllOfPrerequisitesInnerAnyOf1)
	}

	if src.FeatureAllOfPrerequisitesInnerAnyOf2 != nil {
		return json.Marshal(&src.FeatureAllOfPrerequisitesInnerAnyOf2)
	}

	return nil, nil // no data in anyOf schemas
}

type NullableFeatureAllOfPrerequisitesInner struct {
	value *FeatureAllOfPrerequisitesInner
	isSet bool
}

func (v NullableFeatureAllOfPrerequisitesInner) Get() *FeatureAllOfPrerequisitesInner {
	return v.value
}

func (v *NullableFeatureAllOfPrerequisitesInner) Set(val *FeatureAllOfPrerequisitesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureAllOfPrerequisitesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureAllOfPrerequisitesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureAllOfPrerequisitesInner(val *FeatureAllOfPrerequisitesInner) *NullableFeatureAllOfPrerequisitesInner {
	return &NullableFeatureAllOfPrerequisitesInner{value: val, isSet: true}
}

func (v NullableFeatureAllOfPrerequisitesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureAllOfPrerequisitesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
