...
// SpellAllOfDamage - struct for SpellAllOfDamage
type SpellAllOfDamage struct {
	DamageAtCharacterLevel *DamageAtCharacterLevel
	DamageAtSlotLevel *DamageAtSlotLevel
}

// DamageAtCharacterLevelAsSpellAllOfDamage is a convenience function that returns DamageAtCharacterLevel wrapped in SpellAllOfDamage
func DamageAtCharacterLevelAsSpellAllOfDamage(v *DamageAtCharacterLevel) SpellAllOfDamage {
	return SpellAllOfDamage{
		DamageAtCharacterLevel: v,
	}
}

// DamageAtSlotLevelAsSpellAllOfDamage is a convenience function that returns DamageAtSlotLevel wrapped in SpellAllOfDamage
func DamageAtSlotLevelAsSpellAllOfDamage(v *DamageAtSlotLevel) SpellAllOfDamage {
	return SpellAllOfDamage{
		DamageAtSlotLevel: v,
	}
}
...
func (dst *SpellAllOfDamage) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into DamageAtCharacterLevel
	err = newStrictDecoder(data).Decode(&dst.DamageAtCharacterLevel)
	if err == nil {
		jsonDamageAtCharacterLevel, _ := json.Marshal(dst.DamageAtCharacterLevel)
		if string(jsonDamageAtCharacterLevel) == "{}" { // empty struct
			dst.DamageAtCharacterLevel = nil
		} else {
			match++
		}
	} else {
	...
	// try to unmarshal data into DamageAtSlotLevel
	err = newStrictDecoder(data).Decode(&dst.DamageAtSlotLevel)
	if err == nil {
		jsonDamageAtSlotLevel, _ := json.Marshal(dst.DamageAtSlotLevel)
		if string(jsonDamageAtSlotLevel) == "{}" { // empty struct
			dst.DamageAtSlotLevel = nil
		} else {
			match++
		}
	} else {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SpellAllOfDamage)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SpellAllOfDamage)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SpellAllOfDamage) MarshalJSON() ([]byte, error) {
	if src.DamageAtCharacterLevel != nil {
		return json.Marshal(&src.DamageAtCharacterLevel)
	}

	if src.DamageAtSlotLevel != nil {
		return json.Marshal(&src.DamageAtSlotLevel)
	}
...
func (obj *SpellAllOfDamage) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.DamageAtCharacterLevel != nil {
		return obj.DamageAtCharacterLevel
	}

	if obj.DamageAtSlotLevel != nil {
		return obj.DamageAtSlotLevel
	}
...
type NullableSpellAllOfDamage struct {
	value *SpellAllOfDamage
	isSet bool
}

func (v NullableSpellAllOfDamage) Get() *SpellAllOfDamage {
	return v.value
}

func (v *NullableSpellAllOfDamage) Set(val *SpellAllOfDamage) {
	v.value = val
	v.isSet = true
}

func (v NullableSpellAllOfDamage) IsSet() bool {
	return v.isSet
}

func (v *NullableSpellAllOfDamage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpellAllOfDamage(val *SpellAllOfDamage) *NullableSpellAllOfDamage {
	return &NullableSpellAllOfDamage{value: val, isSet: true}
}

func (v NullableSpellAllOfDamage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpellAllOfDamage) UnmarshalJSON(src []byte) error {
	v.isSet = true
