...
// checks if the TraitAllOfTraitSpecificOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraitAllOfTraitSpecificOneOf{}

// TraitAllOfTraitSpecificOneOf struct for TraitAllOfTraitSpecificOneOf
type TraitAllOfTraitSpecificOneOf struct {
	DamageType *TraitAllOfTraitSpecificOneOfDamageType `json:"damage-type,omitempty"`
	BreathWeapon *TraitAllOfTraitSpecificOneOfBreathWeapon `json:"breath-weapon,omitempty"`
}
...
func NewTraitAllOfTraitSpecificOneOf() *TraitAllOfTraitSpecificOneOf {
	this := TraitAllOfTraitSpecificOneOf{}
	return &this
}
...
func (o *TraitAllOfTraitSpecificOneOf) GetDamageType() TraitAllOfTraitSpecificOneOfDamageType {
	if o == nil || IsNil(o.DamageType) {
		var ret TraitAllOfTraitSpecificOneOfDamageType
		return ret
	}
	return *o.DamageType
}
...
// SetDamageType gets a reference to the given TraitAllOfTraitSpecificOneOfDamageType and assigns it to the DamageType field.
func (o *TraitAllOfTraitSpecificOneOf) SetDamageType(v TraitAllOfTraitSpecificOneOfDamageType) {
	o.DamageType = &v
}

// GetBreathWeapon returns the BreathWeapon field value if set, zero value otherwise.
func (o *TraitAllOfTraitSpecificOneOf) GetBreathWeapon() TraitAllOfTraitSpecificOneOfBreathWeapon {
	if o == nil || IsNil(o.BreathWeapon) {
		var ret TraitAllOfTraitSpecificOneOfBreathWeapon
		return ret
	}
	return *o.BreathWeapon
}

// GetBreathWeaponOk returns a tuple with the BreathWeapon field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TraitAllOfTraitSpecificOneOf) GetBreathWeaponOk() (*TraitAllOfTraitSpecificOneOfBreathWeapon, bool) {
	if o == nil || IsNil(o.BreathWeapon) {
		return nil, false
	}
	return o.BreathWeapon, true
}
...
// SetBreathWeapon gets a reference to the given TraitAllOfTraitSpecificOneOfBreathWeapon and assigns it to the BreathWeapon field.
func (o *TraitAllOfTraitSpecificOneOf) SetBreathWeapon(v TraitAllOfTraitSpecificOneOfBreathWeapon) {
	o.BreathWeapon = &v
}

func (o TraitAllOfTraitSpecificOneOf) MarshalJSON() ([]byte, error) {
...
func (o TraitAllOfTraitSpecificOneOf) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DamageType) {
		toSerialize["damage-type"] = o.DamageType
	}
	if !IsNil(o.BreathWeapon) {
		toSerialize["breath-weapon"] = o.BreathWeapon
	}
	return toSerialize, nil
}

type NullableTraitAllOfTraitSpecificOneOf struct {
	value *TraitAllOfTraitSpecificOneOf
	isSet bool
}

func (v NullableTraitAllOfTraitSpecificOneOf) Get() *TraitAllOfTraitSpecificOneOf {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecificOneOf) Set(val *TraitAllOfTraitSpecificOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecificOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecificOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecificOneOf(val *TraitAllOfTraitSpecificOneOf) *NullableTraitAllOfTraitSpecificOneOf {
	return &NullableTraitAllOfTraitSpecificOneOf{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecificOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecificOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
