...
// checks if the TraitAllOfTraitSpecificOneOfDamageType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraitAllOfTraitSpecificOneOfDamageType{}

// TraitAllOfTraitSpecificOneOfDamageType A damage type associated with this trait.
type TraitAllOfTraitSpecificOneOfDamageType struct {
...
func NewTraitAllOfTraitSpecificOneOfDamageType() *TraitAllOfTraitSpecificOneOfDamageType {
	this := TraitAllOfTraitSpecificOneOfDamageType{}
	return &this
}
...
func (o TraitAllOfTraitSpecificOneOfDamageType) MarshalJSON() ([]byte, error) {
...
func (o TraitAllOfTraitSpecificOneOfDamageType) ToMap() (map[string]interface{}, error) {
...
type NullableTraitAllOfTraitSpecificOneOfDamageType struct {
	value *TraitAllOfTraitSpecificOneOfDamageType
	isSet bool
}

func (v NullableTraitAllOfTraitSpecificOneOfDamageType) Get() *TraitAllOfTraitSpecificOneOfDamageType {
	return v.value
}

func (v *NullableTraitAllOfTraitSpecificOneOfDamageType) Set(val *TraitAllOfTraitSpecificOneOfDamageType) {
	v.value = val
	v.isSet = true
}

func (v NullableTraitAllOfTraitSpecificOneOfDamageType) IsSet() bool {
	return v.isSet
}

func (v *NullableTraitAllOfTraitSpecificOneOfDamageType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTraitAllOfTraitSpecificOneOfDamageType(val *TraitAllOfTraitSpecificOneOfDamageType) *NullableTraitAllOfTraitSpecificOneOfDamageType {
	return &NullableTraitAllOfTraitSpecificOneOfDamageType{value: val, isSet: true}
}

func (v NullableTraitAllOfTraitSpecificOneOfDamageType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTraitAllOfTraitSpecificOneOfDamageType) UnmarshalJSON(src []byte) error {
	v.isSet = true
