...
// checks if the ClassLevelClassSpecificAnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassLevelClassSpecificAnyOf{}
...
func (o ClassLevelClassSpecificAnyOf) ToMap() (map[string]interface{}, error) {
