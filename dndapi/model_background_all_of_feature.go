...
// checks if the BackgroundAllOfFeature type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackgroundAllOfFeature{}
...
func (o BackgroundAllOfFeature) ToMap() (map[string]interface{}, error) {
