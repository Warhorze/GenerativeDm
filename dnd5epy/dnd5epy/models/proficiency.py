...
class Proficiency(BaseModel):
    ...
    reference: Optional[ProficiencyAllOfReference] = None
    ...
    def from_dict(cls, obj: dict) -> Proficiency:
        ...
        _obj = Proficiency.parse_obj({
            ...
            "reference": ProficiencyAllOfReference.from_dict(obj.get("reference")) if obj.get("reference") is not None else None
        })
        return _obj
