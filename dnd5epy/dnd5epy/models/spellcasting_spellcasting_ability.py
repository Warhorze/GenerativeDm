...
class SpellcastingSpellcastingAbility(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpellcastingSpellcastingAbility:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpellcastingSpellcastingAbility:
        """Create an instance of SpellcastingSpellcastingAbility from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpellcastingSpellcastingAbility.parse_obj(obj)

        _obj = SpellcastingSpellcastingAbility.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
