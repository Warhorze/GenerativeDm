...
class Spellcasting(BaseModel):
    ...
    spellcasting_ability: Optional[SpellcastingSpellcastingAbility] = None
    ...
    def from_dict(cls, obj: dict) -> Spellcasting:
        ...
        _obj = Spellcasting.parse_obj({
            ...
            "spellcasting_ability": SpellcastingSpellcastingAbility.from_dict(obj.get("spellcasting_ability")) if obj.get("spellcasting_ability") is not None else None
        })
        return _obj
