...
class PrerequisiteAbilityScore(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrerequisiteAbilityScore:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrerequisiteAbilityScore:
        """Create an instance of PrerequisiteAbilityScore from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrerequisiteAbilityScore.parse_obj(obj)

        _obj = PrerequisiteAbilityScore.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
