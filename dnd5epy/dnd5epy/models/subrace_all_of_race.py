...
class SubraceAllOfRace(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubraceAllOfRace:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubraceAllOfRace:
        """Create an instance of SubraceAllOfRace from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubraceAllOfRace.parse_obj(obj)

        _obj = SubraceAllOfRace.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
