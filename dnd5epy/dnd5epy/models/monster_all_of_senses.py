...
class MonsterAllOfSenses(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterAllOfSenses:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterAllOfSenses:
        """Create an instance of MonsterAllOfSenses from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterAllOfSenses.parse_obj(obj)

        _obj = MonsterAllOfSenses.parse_obj({
