...
class ProficiencyAllOfReference(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProficiencyAllOfReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProficiencyAllOfReference:
        """Create an instance of ProficiencyAllOfReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProficiencyAllOfReference.parse_obj(obj)

        _obj = ProficiencyAllOfReference.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
