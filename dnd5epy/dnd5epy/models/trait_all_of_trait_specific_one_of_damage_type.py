...
class TraitAllOfTraitSpecificOneOfDamageType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraitAllOfTraitSpecificOneOfDamageType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraitAllOfTraitSpecificOneOfDamageType:
        """Create an instance of TraitAllOfTraitSpecificOneOfDamageType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraitAllOfTraitSpecificOneOfDamageType.parse_obj(obj)

        _obj = TraitAllOfTraitSpecificOneOfDamageType.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
